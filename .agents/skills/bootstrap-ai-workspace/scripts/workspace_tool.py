...
CORE_COPY_PATHS = [
    ...
    "governance/schemas/mission.schema.json",
    "governance/schemas/agenda.schema.json",
    "governance/schemas/search-node.schema.json",
    "governance/schemas/hypothesis.schema.json",
    "governance/schemas/experiment.schema.json",
    "governance/schemas/evaluation.schema.json",
    "governance/schemas/assignment.schema.json",
    "governance/schemas/event.schema.json",
    "governance/policies/README.md",
    "governance/migrations/README.md",
    "knowledge/README.md",
    ...
    "tests/test_workspace_protocol.py",
...
|---|---|---|
| `workspace_protocol.py` | Persistent autonomous objects, transitions, routes, indexes, leases and handoffs | Authority objects and disposable views, only on explicit subcommands |
...
jobs:
  verify:
    ...
    steps:
      ...
      - run: python3 scripts/workspace_protocol.py validate
